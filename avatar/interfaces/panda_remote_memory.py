...
class PandaRemoteMemoryInterface(RemoteMemoryInterface):
        def __init__(self, sock_address):
            super(PandaRemoteMemoryInterface, self).__init__()
                ...
                try:
                    if request["cmd"] == "read":
                        params = {"address" : int(request["params"]["address"], 16),
                                  ...
                                  "cpu_state": request["cpu_state"] if "cpu_state" in request else None}
